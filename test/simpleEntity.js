...
const getEntityCC2 =
  require("../lib/simpleEntity/getEntityCountry").getEntityCountryCode;

describe("SimpleEntity", function () {
  it("getEntityCountry", function () {
    const lang = "ro";
    return wikiEntity
      .getEntities({ language: lang, ids: ["Q12729770"], claims: "item" })
  ...
  it("Piața Marii Adunări Naționale", function () {
    ...
    return wikiEntity
      .getEntities({
        language: lang,
        titles: ["Piața Marii Adunări Naționale"],
        claims: "item",
        types: true,
        categories: true
      })
  ...
  it("Guvernul Republicii Moldova", function () {
    ...
    return wikiEntity
      .getEntities({
        language: lang,
        titles: ["Guvernul Republicii Moldova"],
        claims: "item",
        types: true,
        categories: true
      })
  ...
  it("BBC: Organisation", function () {
    ...
    const lang = "en";
    return wikiEntity
      .getEntities({ language: lang, titles: ["BBC"], types: true })
      .then(function (entities) {
        const entity = fromWikiEntity(entities[0], lang);
        assert.equal("O", entity.type); //org
      });
